...
import { ArrowRight, Bot, Heart, Music, Palette, PenTool, Shield, Sparkles, Star, Users } from "lucide-react";
import { useRouter } from 'next/navigation';


import { Briefcase, Camera, Leaf, Mic, PenLine } from "lucide-react";
// import { Heart, Sparkles } from "lucide-react"
import { Clapperboard, Globe, HeartPulse, Utensils } from "lucide-react";
...
export default function HomePage() {
  ...
  const CraftPageWelcome = () => {
   ...
   const LiteraryPageWelcome = () => {
    router.push('/Literary/ArtClub/WelcomePage');
  };
