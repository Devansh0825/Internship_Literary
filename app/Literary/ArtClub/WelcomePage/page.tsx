...
export default function ArtClubHomepage() {
  ...
  const goToHeritage = () => {
    router.push("/Literary/Views/Heritage");
  }
  const goToGallery = () => {
    router.push("/Literary/Views/Gallery");
  }
  const goToAffair = () => {
    router.push("/Literary/Views/Affairs");
  }
  const goToCopition = () => {
    router.push("/Literary/Views/Contest");
  }
  const goToHallofFame = () => {
    router.push("/Literary/Views/HallOfFame");
  }
