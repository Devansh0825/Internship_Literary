...
export default function SignIn() {
  ...
  const handleClick1 = () => {
    router.push('/Literary/Auth/SignUp');
  };
  const gotoeditorSignup = () => {
    router.push('/Literary/Auth/EditorSignup');
  };
  const gotoeditorSignin = () => {
    router.push('/Literary/Auth/EditorSignIn');
  };


  const GotoDashBoard = () => {
    router.push('/Literary/home');
  }



  const GotoJudgeSignup = () => {
    router.push('/Literary/Auth/JudgeSignup');
  }
  const GotoJudgeSignin = () => {
    router.push('/Literary/Auth/JudgeSignIn');
  }


  const GotoPrincipleSignUp = () => {
    router.push("/Literary/Auth/PrincipleSignUp")
  }
  const GotoPrincipleSignIn = () => {
    router.push("/Literary/Auth/PrincipleSignIn")
  }
